---
name: outsource-mode-codex
description: 进入外包 + Codex 咨询的分工模式：自己只做调度、决策、审阅、计划，执行交给 /handoff-outsource，难点交给 /consult-codex。
disable-model-invocation: true
argument-hint: "[--outsource \"aid opus xhigh\"] [--consult-effort high]"
---
