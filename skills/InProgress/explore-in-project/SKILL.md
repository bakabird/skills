...
- **Flow into a proposal**: "Ready to start? I can create a change proposal/plan."
- **Result in documents updates**: "Updated documents with these decisions"
...
- **Don't implement** - Never write code or implement features. Creating documents is fine, writing application code is not.
